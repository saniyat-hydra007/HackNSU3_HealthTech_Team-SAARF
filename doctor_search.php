...
<br> <br> <br> <br>
<div style='margin-left:70px'><h4>Looking for Doctor?</h4>
<div style='margin-left:70px'>
    <form action="" method="POST">
        <fieldset>
            ...
            <input style='margin-left:47px' name="hospital_name" type="text" placeholder='Optional' /><br><br>
...
if(isset($_POST['search'])){
  $BG=$_POST['thana'];
  $D=$_POST['district'];
  $T=$_POST['hospital_name'];
  if($T==null){
  $query1 = "SELECT * FROM doctor WHERE thana='$BG'&& district='$D'";
  }
  else{
  $query1 = "SELECT * FROM doctor WHERE thana='$BG' && district='$D' && hospital='$T'";
  }
  ...
  if($result1->num_rows>0){
    ...
    <form method="POST">
    <form action="" method="POST">
    <input type="text"  name="name" size="15"value="<?php echo "Donor_Name" ?>">
    <input type="text" name="designation"size="15" value="<?php echo 'Designation' ?>">
    <input type="text" name="appointment_number" size="15"value="<?php echo 'Appontment_Number' ?>">
    <input type="text" name="thana"size="15" value="<?php echo 'Thana' ?>">
    <input type="text" name="district"size="15" value="<?php echo 'District' ?>">
    <input type="text" name="vigiting_charge"size="15" value="<?php echo 'Vigiting_charge' ?>">
    <input type="text"style=margin-bottom:30px name="hospital_name" size="15"value="<?php echo 'Hospital Name'?>">  
    </form>
    <?php
    ...
    <input type="text" name="designation" size="15" value="<?php echo $row['designation'] ?>">
    <input type="text" name="appointment_number"size="15" value="<?php echo $row['appointment_number'] ?>">
    ...
    <input type="text" name="vigiting_charge"size="15" value="<?php echo $row['vigiting_charge'] ?>">
    <input type="text"style=margin-bottom:30px name="hospital_name"size="15" value="<?php echo $row['hospital_name']  ?>">
    </form>
    <?php
    }
  }
