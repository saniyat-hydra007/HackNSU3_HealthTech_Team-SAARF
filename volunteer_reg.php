...
<br> <br> <br> <br>
<div style='margin-left:70px'><h4>Volunteer Registration.</h4>
<div style='margin-left:70px'>
<form action="server_volunteer.php" method="POST">
        ...
        <br>
        <input type="text" name="id_num" placeholder="NID/Birth Registration Number">
        <br>
