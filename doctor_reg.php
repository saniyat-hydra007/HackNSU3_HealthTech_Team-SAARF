...
<br> <br> <br> <br>
<div style='margin-left:70px'><h4>Baby Registration.</h4>
<div style='margin-left:70px'>
<form action="server_doc.php" method="POST">
        <input type="text" name="name" placeholder="Name">
        <br>
        <input type="text" name="designation" placeholder="Designation">
        <br>
        <input type="text" name="appointment_number" placeholder="Appointment Number">
        <br>
        <input type="text" name="thana" placeholder="Thana">
        <br>
        <input type="text" name="district" placeholder="District">
        <br>
        <input type="text" name="visiting_charge" placeholder="Vigiting Charge">
        <br>
