...
<div style='margin-left:70px'><h4>Nurse Registration</h4>
<div style='margin-left:70px'>
<form action="server_nurse.php" method="POST">
        ...
        <br>
        <input type="text" name="off_day" placeholder="Off Day">
        <br>
        <input type="text" name="wage_per_hour" placeholder="Wage Per Hour">
        <br>
