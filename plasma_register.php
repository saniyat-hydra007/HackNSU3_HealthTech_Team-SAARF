...
<br> <br> <br> <br>
<div style='margin-left:70px'><h4>Kindly fill-up this form to enlist yourself as a plasma donor.</h4>
<div style='margin-left:70px'>
    <form action="plasma_signup.php" method="POST">
        ...
        <br>
        <input type="text" name="donor_name" placeholder="Donor Name">
        <br>
        <input type="text" name="last_date_of_blood_donation" placeholder="Last Date of Blood Donation">
        <br>
        ...
        <br>
        <input type="text" name="Recovered_disease" placeholder="Recovered_disease">
        <br>
        <input type="checkbox"  name="age_confirmation" >
        <label for="age_confirmation"> I am over 18.</label><br>
     ...
     <div class="container">
       <div class="row">
         ...
         <div class="col-lg-3 col-md-6 footer-info">
           <h3>About Medica</h3>
           <p>It’s a website that is dedicated for emergency medical information and medical purpose. It will provide information during med
